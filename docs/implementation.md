...
- **멈춘 Work의 [재개](3.3):** 멈추게 한 task의 기본 다음 단계를 시작한다. 이전 단계 추천(D23)으로 멈췄으면 추천을 따르지 않고 기본 다음 단계로 간다(추천대로 되돌아가는 것은 M4의 단계 선택). verify에서 멈췄으면 Work를 완료한다.
